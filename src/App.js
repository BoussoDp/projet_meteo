...
function App() {
  ...
  useEffect(() => { 
    ...
    fetch(`https://api.openweathermap.org/data/2.5/weather?lat=14.6479200&lon=-16.2436300&appid=68acf26ba4961816b4475c03396ec2e9&units=metric`)
  ...
  useEffect(() => { 
    ...
    fetch(`https://api.openweathermap.org/data/2.5/weather?q=Thiebo&appid=68acf26ba4961816b4475c03396ec2e9&units=metric`)
      .then(result => result.json())
      .then(jsonresult => {
        setTemp(jsonresult.main.temp);
        setDesc(jsonresult.weather[0].main);
